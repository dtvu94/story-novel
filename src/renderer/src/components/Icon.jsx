...
const PATHS = {
  ...
  library: <><path d="M4 4v16" /><path d="M8 4v16" /><rect x="12" y="4" width="8" height="16" rx="1" transform="rotate(8 16 12)" /></>,
  ...
  aA: <><path d="M4 20 9 6l5 14" /><path d="M6 15h6" /><path d="m15 20 3.5-9 3.5 9" /><path d="M16.2 17.5h4.6" /></>,
